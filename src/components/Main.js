        ...
        <div className="profile__container">
          ...
          <div className="profile__info">
            <div className="profile__info-container">
              ...
              <button className="profile__btn profile__btn_type_edit" type="button"><img src={editBtn} alt="редактировать профиль" className="profile__btn-icon profile__btn-icon_type_edit" /></button>
            </div>
            <p className="profile__job"></p>
          </div>
        </div>
        <button className="profile__btn profile__btn_type_add" type="button"><img src={addBtn} alt="добавить карточку" /></button>
      </section>
